...
export const useGameActions = ({
  ...
  }, [session, supabase, currentPath, isPlayerAlive, playerTerritory, otherPlayers, setCurrentPath, setPlayerTerritory, setPlayerScore, setOtherPlayers, isClaiming]);
  ...
  }, [session, supabase, respawnTimer, setIsPlayerAlive, setCurrentPath, setPlayerTerritory, setPlayerScore, setCurrentLocation, setRespawnTimer, isRespawning]);

  return { handleClaimTerritory, handleRespawn, isClaiming, isRespawning };
};